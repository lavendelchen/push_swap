...
void			init_l_i_s( \
				t_list *stack_a, t_list *stack_b, unsigned int numnum);
void			init_three_sort( \
				t_list *stack_a, t_list *stack_b, unsigned int numnum);
void			find_shortest_combination( \
				t_sort *sort, t_shortest_path *shortest_path);
