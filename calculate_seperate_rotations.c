...
/*   Updated: 2022/03/06 23:02:36 by shaas            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	calculate_seperate_rotations(t_node *node, t_sort *sort, t_list *stack_a, t_list *stack_b)
{
	...
	bottom = find_bottom(stack_a, node); //problem here!!
	...
	// i mean, we've tested this. i don't thik that's where the problem lies. or maybe it does
	// because of a lack of re-initializing a value?
}
